  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-100 font-sans selection:bg-emerald-500/30 print:bg-white print:text-slate-900 py-4 sm:py-10 px-2 sm:px-6 md:px-8">
      ...
      <div className="max-w-4xl mx-auto mb-4 sm:mb-6 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 print:hidden">
        <Link
          href="/"
          className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-white text-xs font-bold uppercase tracking-wider transition-all border border-white/10"
        >
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handlePrint}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl bg-emerald-400 text-black text-xs font-extrabold uppercase tracking-widest hover:bg-emerald-300 transition-all shadow-[0_0_20px_rgba(52,211,153,0.3)] active:scale-95 cursor-pointer"
          >
      ...
      <div className="max-w-4xl mx-auto bg-slate-950 border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-8 md:p-10 shadow-2xl print:shadow-none print:border-none print:bg-white print:p-0 print:text-slate-900">
        
        {/* Paper-First Resume Header */}
        <header className="border-b border-white/10 print:border-slate-900 pb-5 sm:pb-6 print:pb-4">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
            <div className="space-y-1">
              <h1 className="text-2xl sm:text-4xl font-extrabold tracking-tight text-white print:text-slate-950 print:text-3xl">
                {personal.name}
              </h1>
            ...
            <div className="text-xs space-y-1 text-slate-300 print:text-slate-800 font-medium break-all sm:break-normal">
              <div className="flex items-center gap-1.5 flex-wrap sm:flex-nowrap">
                <Mail className="size-3.5 text-emerald-400 print:hidden shrink-0" />
                <span className="print:font-semibold">Email:</span>
                <a href={`mailto:${personal.email}`} className="hover:underline text-emerald-300 sm:text-slate-300 print:text-slate-800">{personal.email}</a>
              </div>
          ...
          {/* Executive Summary */}
          <div className="mt-4 p-3.5 sm:p-4 rounded-xl sm:rounded-2xl bg-white/5 border border-white/5 print:bg-transparent print:border-none print:p-0 print:mt-3">
        ...
        <section className="py-4 sm:py-5 border-b border-white/10 print:border-slate-300 print:py-4">
          <h2 className="text-[11px] sm:text-xs font-extrabold uppercase tracking-widest text-emerald-400 print:text-slate-950 print:text-sm print:font-bold mb-3 print:mb-2 print:border-b print:border-slate-400 print:pb-1">
            Education
          </h2>
        ...
        <section className="py-4 sm:py-5 border-b border-white/10 print:border-slate-300 print:py-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 print:grid-cols-3 print:gap-3">
            {skills.map((group) => (
              <div key={group.category} className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-slate-900/60 border border-white/5 print:bg-transparent print:border-none print:p-0 space-y-2">
        ...
        {/* Featured Projects */}
        <section className="pt-4 sm:pt-5 print:pt-4">
          <h2 className="text-[11px] sm:text-xs font-extrabold uppercase tracking-widest text-emerald-400 print:text-slate-950 print:text-sm print:font-bold mb-3 print:mb-2 print:border-b print:border-slate-400 print:pb-1">
            Key Engineering Projects
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 print:grid-cols-2 print:gap-3">
            {projects.map((proj, idx) => (
              <div key={idx} className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-slate-900/60 border border-white/5 print:bg-transparent print:border-none print:p-0 space-y-1">
