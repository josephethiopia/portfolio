...
export default function CustomCursor() {
  ...
  return (
    <>
      <div
        ref={cursorRef}
        className="hidden md:block fixed w-[8px] h-[8px] bg-emerald-400 rounded-full pointer-events-none z-[999] shadow-[0_0_15px_rgba(52,211,153,0.5)] transition-[transform,opacity] duration-300 ease-linear"
      />
      <div
